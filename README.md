...
**If you are picking this up cold — human or agent — read these three, in order:**
...
**The repository is the system of record.** It wins any disagreement with a summary, a branch, a working copy, or anyone's recollection — including the owner's. Clone fresh and read state from here.
